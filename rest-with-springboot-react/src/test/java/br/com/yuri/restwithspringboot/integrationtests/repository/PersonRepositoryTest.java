package br.com.yuri.restwithspringboot.integrationtests.repository;
...
public class PersonRepositoryTest extends AbstractIntegrationTest {
	...
	public void testFindByName() throws JsonMappingException, JsonProcessingException {
		...
		person = repository.findPeopleByName("yuri", pageable).getContent().get(0);
		...
		assertEquals("Yuri", person.getFirstName());
		assertEquals("Costa", person.getLastName());
		assertEquals("Sao Paulo", person.getAddress());
